= https://nextnormal.academy[nextnormal.academy] PDF Theme

This repository contains the *PDF theme* for nextnormal.academy curricula and other official documents.
